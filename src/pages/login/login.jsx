...
<form onSubmit={handleOnSubmit}>
  <div className="w-[400px] h-[500px] backdrop-blur-xl rounded-2xl flex justify-center items-center flex-col relative">
    ...
    {/* Here: login and register buttons side by side */}
    <div className="flex space-x-4 my-6">
      <button
        type="submit"
        className="w-[140px] h-[50px] bg-[#efac38] text-xl text-white rounded-lg"
      >
        Login
      </button>
      <Link to="/register">
    ...
    {/* Google login button */}
    <div
  className="my-6 w-[300px] h-[50px] bg-white text-black rounded-lg flex items-center justify-center gap-3 cursor-pointer"
  onClick={googleLogin}
>
  <img src="/public/google-icon.png" alt="Google" className="w-6 h-6" />
